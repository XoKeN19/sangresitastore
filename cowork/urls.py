...
urlpatterns = [
    ...
    path('tarjetas-regalo', views.mostrarTarjetasRegalo, name='tarjetas_regalo'),
    path('detalle-videojuego/<int:videojuego_id>', views.detalleVideojuego, name='detalle_videojuego'),
    path('detalle-tarjeta-regalo/<int:tarjeta_regalo_id>', views.detalleTarjetaRegalo, name='detalle_tarjeta_regalo'),
    ...
    path('gestionar-tarjetas-regalo', views.gestionarTarjetasRegalo, name='gestionar_tarjetas_regalo'),
    path('editar-videojuego/<int:videojuego_id>', views.mostrarEditarVideojuego, name='editar_videojuego'),
    path('editar-tarjeta-regalo/<int:tarjeta_regalo_id>', views.mostrarEditarTarjetaRegalo, name='editar_tarjeta_regalo'),
